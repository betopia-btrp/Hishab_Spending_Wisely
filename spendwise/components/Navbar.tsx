...
import { Search, Bell, Menu, User as UserIcon, Keyboard, X, Check, Clock } from 'lucide-react';
...
export default function Navbar() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      console.log('Notifications fetch error (expected if not logged in):', err.response?.status);
      setNotifications([]);
      setUnreadCount(0);
    }
  };
