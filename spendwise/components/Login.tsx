...
import { Wallet, LogIn, Lock, Mail, User as UserIcon, ArrowLeft, CheckCircle } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || `${isRegistering ? 'Registration' : 'Login'} failed.`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-slate-100">
          ...
          <div className="bg-slate-900 p-10 text-center">
            ...
            <h1 className="text-3xl font-extrabold text-white tracking-tight">SpendWise</h1>
            <p className="text-slate-400 mt-2 text-sm">Context-Aware Expense Management</p>
          </div>
